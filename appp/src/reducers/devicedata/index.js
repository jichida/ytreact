...
const initial = {
    devicedata: {
      ...
      inwatersettings:{//进水设定
        tds:'1',//进水TDS	进水TDS  word	1 word
        conductivity:'2',//50	进水电导率	进水电导率  word	1 word
        hardness:'3',//进水硬度	进水硬度  word	1 word
        alkalinity:'4',//进水碱度	进水碱度  word	1 word
        ph:'5',//49	进水PH	进水的PH值  byte	1 byte
      },
    },
